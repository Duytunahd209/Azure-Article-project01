...
class Config(object):
    ...
    CLIENT_SECRET = "Kpd8Q~XVCsm.EtpXzEPCGjmhm8pdc.NcswRfibuP"
    ...
    CLIENT_ID = "f5d9e25f-c6a7-484d-b5f9-8275d671523b"
    ...
    SESSION_TYPE = "filesystem"  # Token cache will be stored in server-side sessionaa
